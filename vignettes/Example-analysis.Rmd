...
```{r, fig.cap="Proportion of dry and not dry food"}
df %>%
  count(food_dry) %>%
...
```{r, fig.cap="Proportion of food consumption pattern"}
p1 <- df %>% 
  group_by(food_dry) %>%
  summarise(count = n()) %>%
...
```{r, fig.cap="Comparison between prey counts and age"}
...
```{r, fig.cap="Comparison between prey counts and hours indoor"}
...
```{r, fig.cap="Comparison between prey counts and GPS strap time"}
df %>% 
...
```{r, fig.cap="Comparison between prey counts and food type"}
